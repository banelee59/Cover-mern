...
const BusinessDetails = ({ formData, errors, touched, handleChange, setTouched, associations }) => {
  return (
    <div className="space-y-6 bg-white p-6 rounded-lg shadow-sm">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div>
          ...
          <input
            ...
            className={`w-full px-4 py-2 border rounded-lg focus:ring-[#00c2ff] focus:border-[#00c2ff]
              ${errors.registrationNumber && touched.registrationNumber ? 'border-red-500' : 'border-gray-300'}`}
            required
          />
        ...
        <div>
          ...
          <input
            ...
            className={`w-full px-4 py-2 border rounded-lg focus:ring-[#00c2ff] focus:border-[#00c2ff]
              ${errors.dateEstablished && touched.dateEstablished ? 'border-red-500' : 'border-gray-300'}`}
            required
          />
      ...
      <div className="w-full max-w-md">
        ...
        <select
          ...
          className={`w-full px-4 py-2 border rounded-lg focus:ring-[#00c2ff] focus:border-[#00c2ff]
            ${errors.association && touched.association ? 'border-red-500' : 'border-gray-300'}`}
          required
        >
